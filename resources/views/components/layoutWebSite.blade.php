                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <div class="flex space-x-4 space-x-reverse">
                            <a href="#"
                                class="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-primary transition">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-400 hover:text-white transition">الصفحة
                                    الرئيسية</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition">عرض المشاريع</a>
                            </li>
                            <li><a href="{{ route('project.create') }}"
                                    class="text-gray-400 hover:text-white transition">أضف مشروعك</a>
                            </li>
                          
                            <li><a href="https://readdy.ai/home/c49c4523-9dea-407b-86aa-316c56817127/13754077-ea2a-481e-820f-5f83ef084beb"
                                    data-readdy="true" class="text-gray-400 hover:text-white transition">تواصل
                                    معنا</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-400 hover:text-white transition">طبخ منزلي</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition">حرف يدوية</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition">تصميم</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition">تعليم خاص</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition">خدمات فردية</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-400">+970 59 123 4567</span>
                            </li>
                            <li class="flex items-center">
                                <i class="ri-mail-line ml-2"></i>
                                <span class="text-gray-400">info@riwaq.ps</span>
                            </li>
                        </ul>
                    </div>
                </div>
