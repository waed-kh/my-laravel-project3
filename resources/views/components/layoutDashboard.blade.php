        ...
        <aside
            ...
            <div class="h-19">
                ...
                <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700"
                    ...
                    <img src="{{ asset('backend/assets/img/logo-ct-dark.png') }}"
                    ...
                    <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                        ...
                        <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                            ...
                            <li class="relative flex items-center pr-2">
                                ...
                                <a href="javascript:;"
                                    class="block p-0 text-sm text-white transition-all ease-nav-brand" dropdown-trigger
                                    aria-expanded="false">
            ...
            <div class="w-full px-6 py-6 mx-auto">
                ...
                <div class="flex flex-wrap -mx-3">
                    <div class="flex-none w-full max-w-full px-3 ">
                        <div
                            class="content-here relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border ">
                            {{ $slot ?? '' }}
                        </div>
                    </div>
                </div>
