...
@media (prefers-color-scheme: dark) {
        ...
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                <li class="text-sm leading-normal">
                    <a class="text-white opacity-50" href="javascript:;">Locations</a>
                </li>
    ...
    <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparen ">
        <div class="flex-grow">
            <h6 class="dark:text-white">Locations table</h6>
        </div>
        <div class="text-center mx-3">
           <a href="{{ route('admin.location.create') }}" class="link-create">Create</a>
                    ...
                    @forelse ($locations as $location)
                        <tr>
                            ...
                            <td
                                ...
                                <span
                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">{{ $location->created_at->format('Y/d/m') }}</span>
                            </td>
                            <td
                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                ...
                                <form action="{{ route('admin.location.destroy', $location->id) }}" class="inline"
                                    method="POST">
                                    @csrf
                                    @method('delete')
                                    <button
