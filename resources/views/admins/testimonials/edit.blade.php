...
@media (prefers-color-scheme: dark) {
    ...
    <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparen ">
        <div class="flex-grow">
            <h6 class="dark:text-white"> تعديل التقييم </h6>
        </div>
        <div class="text-center mx-3">
            <a href="{{ route('admin.testimonial.index') }}"
                class="mx-1 rounded-lg bg-blue-700 px-3 py-2 text-xs font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> جميع التققيمات
                </a>
        </div>
    </div>
