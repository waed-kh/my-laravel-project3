...
.green-button:focus {
    box-shadow: 0 0 0 4px rgba(134, 239, 172, 0.5); /* green-300 */
}
...
@media (prefers-color-scheme: dark) {
    ...
    .green-button:focus {
        box-shadow: 0 0 0 4px rgba(5, 150, 105, 0.5); /* green-800 */
    }
}
...
@media (prefers-color-scheme: dark) {
    ...
    <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparen ">
        <div class="flex-grow">
            <h6 class="dark:text-white">  انشاء الخدمة</h6>
        </div>
        <div class="text-center mx-3" style="display: flex; justify-content: center; gap: 0.5rem; align-items: center;">
    <a href="{{ route('admin.service.index') }}" class="blue-button"> جميع الخدمات </a>
        ...
        <div class="p-0 overflow-x-auto">
            <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mx-3 px-3 my-2 w-100">
                  <button class="green-button"> انشاء</button>
