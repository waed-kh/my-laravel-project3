...
@media (prefers-color-scheme: dark) {
        ...
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                <li class="text-sm leading-normal">
                    <a class="text-white opacity-50" href="javascript:;"> التصنيفات</a>
                </li>
    ...
    <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparen ">
        <div class="flex-grow">
            <h6 class="dark:text-white">  جدول التصنيفات</h6>
        </div>
        ...
        @forelse ($categories as $category)
            <tr>
                ...
                <td class="px-4 py-2 text-center border-b dark:border-white/40">
                    <a href="{{ route('admin.category.edit', $category->id) }}" class="text-blue-500 hover:text-blue-700 mx-1">
                        <i class="fas fa-edit" style="font-size:15px;"></i>
                    </a>
                    <form action="{{ route('admin.category.destroy', $category->id) }}" method="POST" class="inline delete-form">
                        @csrf
                        @method('DELETE')
                        <button type="button" class="text-red-600 hover:text-red-800 mx-1 delete-button">
