                    ...
                    @forelse ($projects as $project)
                        <tr>
                            <td
                                ...
                                <img src="{{ $project->img_path }}" width="100px" height="100px" class="rounded-xl"
                                    alt="{{ $project->title }}" />
                            </td>
                            <td
                            ...
                            <td
                                class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                <span
                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">{{ $project->created_at->format('Y/d/m') }}</span>
                            </td>
                            <td
                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                ...
                                <form action="{{ route('admin.project.destroy', $project->id) }}" class="inline"
                                    method="POST">
                                    @csrf
                                    @method('delete')
                                    <button
