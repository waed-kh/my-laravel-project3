        ...
        <div class="flex flex-col md:flex-row min-h-screen">
            ...
            <div
                ...
                <div class="text-center">
                    ...
                    <img src="https://readdy.ai/api/search-image?query=A%20professional%20illustration%20showing%20a%20diverse%20group%20of%20freelancers%20working%20on%20various%20projects%2C%20with%20a%20clean%20minimalist%20style.%20The%20image%20shows%20people%20collaborating%20on%20a%20digital%20platform%2C%20with%20subtle%20blue%20accents.%20The%20background%20is%20light%20and%20airy%2C%20with%20soft%20gradients.%20The%20illustration%20style%20is%20modern%20and%20professional%2C%20suitable%20for%20a%20freelance%20marketplace%20website.&width=600&height=500&seq=123&orientation=landscape"
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-gray-600">اكتشف أفضل المواهب المحلية لإنجاز مشاريعك بكفاءة عالية وأسعار منافسة
                        </p>
                    </div>
                </div>
            </div>
...
<p id="passwordError" class="text-red-500 text-xs hidden">يجب أن تكون كلمة المرور 8 أحرف على الأقل</p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm text-primary hover:text-primary-dark">نسيت كلمة المرور؟</a>
                        </div>
                        <!-- زر تسجيل الدخول -->
                        <button type="submit"
                    ...
                    <div class="text-center mt-6">
                        <p class="text-gray-600">
                            ...
                            <a href="{{route('register')}}"
                                data-readdy="true" class="text-primary font-medium hover:underline">
                                إنشاء حساب جديد
                            </a>
                        </p>
                    </div>
