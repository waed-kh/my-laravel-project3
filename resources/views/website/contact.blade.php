        ...
        <div class=" container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-40"> <!-- المربعات ترتفع للأعلى -->
                ...
                <div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600 mb-3">نحن متاحون للرد على استفساراتك</p> 0597654210
                    <a href="tel:+97059123456" id="o10" class="hover:text-primary/80 font-medium">
                        </a>
                </div>
                <!-- مربع 2 -->
                <div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                    ...
                    <a href="mailto:info@riwaq.ps"
                      id="o10"  class="hover:text-primary/80 font-medium">info@bkra.ps</a>
                </div>
                <!-- مربع 3 -->
                <div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                    <div class="w-16 h-16 flex items-center justify-center bg-primary/10 rounded-full mb-4">
  ...
  <section class="py-12 bg-primary/5">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-gray-600 mb-8 max-w-2xl mx-auto">
            تابعنا للحصول على آخر الأخبار والتحديثات حول المشاريع الجديدة والعروض الخاصة
        </p>
    ...
    <input type="email" name="email" placeholder="أدخل بريدك الإلكتروني"
        class="flex-1 px-4 py-3 rounded border-none text-sm @error('email') border-red-500 @enderror"
...
{{-- عرض رسالة الخطأ --}}
@error('email')
    <p class="text-red-600 mt-2 text-center">{{ $message }}</p>
@enderror
             ...
             document.addEventListener("DOMContentLoaded", function () {
                ...
                faqItems.forEach(item => {
                    item.addEventListener("click", function () {
                        const answer = this.querySelector(".text-gray-600");

                        // إغلاق باقي الأجوبة إذا أردت واحد فقط مفتوح
                        document.querySelectorAll(".text-gray-600").forEach(el => {
                            if (el !== answer) el.classList.add("hidden");
                        });

                        // تبديل إظهار/إخفاء الجواب
                        answer.classList.toggle("hidden");

                        // تدوير السهم للأسفل عند الفتح
